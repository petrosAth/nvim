...
function M.get_highlight_groups(palette)
    ...
    g.editor = {
        ...
        FloatTitle = { fg = p.cCyan, bg = p.cFill1 },
    ...
    g.plugins = {
        ...
        -- snacks.nvim
        SnacksNotifierTitleError = { fg = p.cRed, bg = g.editor.Normal.bg },
        SnacksNotifierTitleWarn = { fg = p.cYellow, bg = g.editor.Normal.bg },
        SnacksNotifierTitleInfo = { fg = p.cCyan, bg = g.editor.Normal.bg },
        SnacksNotifierTitleDebug = { fg = p.cOrange, bg = g.editor.Normal.bg },
        SnacksNotifierTitleTrace = { fg = p.cSelect, bg = g.editor.Normal.bg },
        SnacksNotifierIconError = { fg = p.cRed, bg = g.editor.Normal.bg },
        SnacksNotifierIconWarn = { fg = p.cYellow, bg = g.editor.Normal.bg },
        SnacksNotifierIconInfo = { fg = p.cCyan, bg = g.editor.Normal.bg },
        SnacksNotifierIconDebug = { fg = p.cOrange, bg = g.editor.Normal.bg },
        SnacksNotifierIconTrace = { fg = p.cSelect, bg = g.editor.Normal.bg },
        SnacksNotifierBorderError = { fg = p.cRed, bg = g.editor.Normal.bg },
        SnacksNotifierBorderWarn = { fg = p.cYellow, bg = g.editor.Normal.bg },
        SnacksNotifierBorderInfo = { fg = p.cCyan, bg = g.editor.Normal.bg },
        SnacksNotifierBorderDebug = { fg = p.cOrange, bg = g.editor.Normal.bg },
