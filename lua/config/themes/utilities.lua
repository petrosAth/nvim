local hsluv = require("config.themes.hsluv")

local M = {}

-- Source:
-- https://github.com/folke/tokyonight.nvim/blob/66bfc2e8f754869c7b651f3f47a2ee56ae557764/lua/tokyonight/util.lua
---@param color string Hex color code
---@return table RGB color code
...
---@return string Hex color with the given propert(y|ies) modified
