...
function M.load(palette)
    ...
    g.editor = {
        ...
        SpellBad = { bg = p.none, sp = p.cRed, underline = true },
        SpellCap = { bg = p.none, sp = p.cYellow, underline = true },
        SpellLocal = { bg = p.none, sp = p.cFg, underline = true },
        SpellRare = { bg = p.none, sp = p.cFgLight, underline = true },
        ...
        LineNrAbove = { fg = p.cFill4, bg = p.none },
        LineNr = { fg = p.cFg, bg = p.none },
        LineNrBelow = { fg = p.cFill4, bg = p.none },
    ...
    g.diagnostic = {
        ...
        DiagnosticUnderlineHint = { bg = p.none, underdotted = true, sp = p.cSelect },
