...
function M.load(palette)
   ...
   g.treesitter = {
        ...
        ["@parameter"]             = { fg = p.cSelect },
        ["@method"]                = { fg = p.cViolet, italic = true },
        ["@method.call"]           = { fg = p.cViolet, italic = true },
        ["@field"]                 = { fg = p.cFg },
        ["@property"]              = { fg = p.cSelect, italic = true },
        ["@constructor"]           = { fg = p.cBlue },
        ...
        ["@attribute"]             = g.syntax.Annotation,

        ["@variable"]              = g.syntax.Identifier,
        ["@variable.builtin"]      = { fg = g.syntax.Identifier.fg, bold = true },
        ["@variable.global"]       = { fg = g.syntax.Identifier.fg, bold = true },

        ["@text"]                  = g.syntax.Normal,
        ["@text.strong"]           = { bold = true },
        ["@text.emphasis"]         = { italic = true },
        ["@text.underline"]        = { underline = true },
        ["@text.strike"]           = { strikethrough = true },
        ["@text.title"]            = { fg = p.cBlue, bold = true },
        ["@text.literal"]          = { fg = p.cFg },
        ["@text.uri"]              = { fg = p.cSelect, italic = true },
        ["@text.math"]             = g.syntax.Number,
        -- ["@text.environment"]      = {},
        -- ["@text.environment.name"] = {},
        ["@text.reference"]        = g.syntax.Comment,
        ["@text.note"]             = g.syntax.DiagnosticHint,
        ["@text.warning"]          = g.syntax.DiagnosticWarn,
        ["@text.danger"]           = g.syntax.DiagnosticError,
        ["@todo"]                  = g.syntax.DiagnosticInfo,
        ["@tag"]                   = g.syntax.Tag,
        ["@tag.attribute"]         = g.syntax.Tag,
