        ...
        highlights = {
            nord = {
                ...
                plugins = {
                    ...
                    bufferline = {
                        BufferLineDiagnostic                = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineDiagnosticVisible         = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineDiagnosticSelected        = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineErrorDiagnostic           = { fg = "#BF616A", bg = "#4C566A" },
                        BufferLineErrorDiagnosticVisible    = { fg = "#BF616A", bg = "#4C566A" },
                        BufferLineErrorDiagnosticSelected   = { fg = "#BF616A", bg = "#81A1C1" },
                        BufferLineError                     = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineErrorVisible              = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineErrorSelected             = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineWarningDiagnostic         = { fg = "#EBCB8B", bg = "#4C566A" },
                        BufferLineWarningDiagnosticVisible  = { fg = "#EBCB8B", bg = "#4C566A" },
                        BufferLineWarningDiagnosticSelected = { fg = "#EBCB8B", bg = "#81A1C1" },
                        BufferLineWarning                   = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineWarningVisible            = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineWarningSelected           = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineInfoDiagnostic            = { fg = "#88C0D0", bg = "#4C566A" },
                        BufferLineInfoDiagnosticVisible     = { fg = "#88C0D0", bg = "#4C566A" },
                        BufferLineInfoDiagnosticSelected    = { fg = "#88C0D0", bg = "#81A1C1" },
                        BufferLineInfo                      = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineInfoVisible               = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineInfoSelected              = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineHintDiagnostic            = { fg = "#5E81AC", bg = "#4C566A" },
                        BufferLineHintDiagnosticVisible     = { fg = "#5E81AC", bg = "#4C566A" },
                        BufferLineHintDiagnosticSelected    = { fg = "#5E81AC", bg = "#81A1C1" },
                        BufferLineHint                      = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineHintVisible               = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineHintSelected              = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineGroupSeparator            = { fg = "#b48ead", bg = "#a3be8c" },
                        BufferLineGroupLabel                = { fg = "#b48ead", bg = "#a3be8c" },
                        BufferLineNumbers                   = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineNumbersVisible            = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineNumbersSelected           = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineBuffer                    = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineBufferVisible             = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineBufferSelected            = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineTab                       = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineTabSelected               = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineTabClose                  = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineCloseButton               = { fg = "#E5E9F0", bg = "#4C566A" },
                        BufferLineCloseButtonVisible        = { fg = "#81A1C1", bg = "#4C566A" },
                        BufferLineCloseButtonSelected       = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineSeparator                 = { fg = "#3B4252", bg = "#4C566A" },
                        BufferLineSeparatorVisible          = { fg = "#3B4252", bg = "#4C566A" },
                        BufferLineSeparatorSelected         = { fg = "#3B4252", bg = "#81A1C1" },
                        BufferLineDuplicate                 = { fg = "#D8DEE9", bg = "#4C566A", style = "bold" },
                        BufferLineDuplicateVisible          = { fg = "#D8DEE9", bg = "#4C566A", style = "bold" },
                        BufferLineDuplicateSelected         = { fg = "#3B4252", bg = "#81A1C1", style = "bold" },
                        BufferLineModified                  = { fg = "#EBCB8B", bg = "#4C566A" },
                        BufferLineModifiedVisible           = { fg = "#EBCB8B", bg = "#4C566A" },
                        ...
                        BufferLineFill                      = { fg = "#D8DEE9", bg = "#3B4252" },
                    },
                    cmp = {
                        CmpItemMenu = { fg = "#d8dee9", bg = "NONE"    },
