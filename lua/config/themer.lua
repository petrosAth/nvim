        ...
        highlights = {
            nord = {
                base = {
                    ...
                    NormalNC         = { fg = p.nord4,   bg = p.nord0d   },
                    Pmenu            = { fg = p.nord4,   bg = p.nord1,   style = "none" },
                    PmenuSel         = { fg = p.nord8,   bg = p.nord3    },
                    PmenuSbar        = { fg = p.nord4,   bg = p.nord3    },
                    PmenuThumb       = { fg = p.nord8,   bg = p.nord1    },
                    ...
                    NormalFloat      = { fg = p.nord4,   bg = p.nord0    },
                    FloatBorder      = { fg = p.nord8,   bg = p.nord0    },
                    -- Search
                    ...
                    DiffAdd          = { fg = "none",    bg = p.nord14d  },
                    DiffChange       = { fg = "none",    bg = p.nord13d  },
                    DiffDelete       = { fg = "none",    bg = p.nord11d  },
                },
                plugins = {
                    alpha = {
                    ...
                    bufferline = {
                        ...
                        BufferLineNumbersVisible            = { fg = p.nord6,   bg = p.nord3l   },
                        BufferLineNumbersSelected           = { fg = p.nord1,   bg = p.nord9    },
                        BufferLineBuffer                    = { fg = p.nord4,   bg = p.nord3    },
                        BufferLineBufferVisible             = { fg = p.nord6,   bg = p.nord3l   },
                    ...
                    cmp = {
                        CmpGhostText          = { fg = p.nord3l,  bg = "none",    style = "bold" },
                        CmpItemAbbr           = { fg = p.nord9,   bg = "none",    style = "bold" },
                        CmpItemKind           = { fg = p.nord6,   bg = "none"     },
                        CmpItemMenu           = { fg = p.nord6,   bg = "none"     },
                        CmpItemAbbrDeprecated = { fg = p.nord12,  bg = "none",    style = "strikethrough" },
                        CmpItemAbbrMatch      = { fg = p.nord4,   bg = "none"     },
                        CmpItemAbbrMatchFuzzy = { fg = p.nord4,   bg = "none"     },
                        CmpItemKindSnippet    = { fg = p.nord13,  bg = "none"     },
                        CmpItemKindVariable   = { fg = p.nord10,  bg = "none"     },
                        CmpItemKindInterface  = { fg = p.nord10,  bg = "none"     },
                        CmpItemKindText       = { fg = p.nord10,  bg = "none"     },
                        CmpItemKindFunction   = { fg = p.nord8,   bg = "none"     },
                        CmpItemKindMethod     = { fg = p.nord8,   bg = "none"     },
                        CmpItemKindKeyword    = { fg = p.nord4,   bg = "none"     },
                        CmpItemKindProperty   = { fg = p.nord4,   bg = "none"     },
                        CmpItemKindUnit       = { fg = p.nord4,   bg = "none"     },
                    },
                    dressing = {
                    ...
                    gitsigns = {
                        ...
                        GitSignsAddInline        = { fg = "none",    bg = p.nord14d  },
                        GitSignsChangeInline     = { fg = "none",    bg = p.nord13d  },
                        GitSignsDeleteInline     = { fg = "none",    bg = p.nord11d  },
                    },
                    indentline = {
                    ...
                    lsp = {
                        ...
                        -- Neovim lspconfig
                        LspCodeLens                 = { fg = p.nord3l,  bg = "none"     },
                    ...
                    telescope = {
                        ...
                        TelescopeResultsBorder  = { fg = p.nord9,   bg = p.nord0    },
                        TelescopePreviewBorder  = { fg = p.nord7,   bg = p.nord0    },
